...
export const RouteParametersSchema = z.object({
  ...
  location: z.object({
    ...
    landmarkTraversalModes: z.array(z.enum(['around', 'through', 'along'])).optional(),
    avoidStreets: z.array(z.string()).default([]),
    neighborhood: z.string().nullable(),
    region: z.string().nullable(),
  }),
  shape: z.object({
    type: z.enum(['loop', 'out-and-back', 'point-to-point', 'lollipop', 'flexible']),
